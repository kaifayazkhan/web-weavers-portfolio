...
export default function Banner() {
  return (
    <div className="flex-cols flex-col-reverse md:flex-row flex-between gap-8 mt-8">
      <div className="flex-1 flex-cols gap-3 md:max-w-lg">
        <h4 className="text-sm font-bold">Hi I am</h4>
        <h3 className="text-primaryCTA text-xl font-bold">Mohammad Umair</h3>
        <h1 className="text-large relative">
          UI & UX <br className="hidden md:block" /> <span className="text-end md:flex-center ">Designer</span>
        </h1>
      ...
      <div className="flex-1 relative w-full h-full flex justify-center md:justify-end">
        <Image src="/assets/hero.png" alt="Hero" className="object-scale-down relative w-60 sm:w-72 md:w-96" width={400} height={400} />
      </div>
    </div>
  )
}
